...
#pragma warning(pop)
        ...
        _Out_ uint8_t &endpointU_1) noexcept
    {
        ...
        //  If there are boundary values in input texels, should use 4 interpolated clearColor values to guarantee
        ...
        {
            // 6 interpolated clearColor values
        ...
        {
            // 4 interpolated clearColor values
