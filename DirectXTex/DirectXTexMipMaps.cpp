...
namespace DirectX
{
    ...
    //--- Resizing clearColor and alpha channels separately using WIC ---
        ...
        const Image* img) noexcept
    {
        ...
        // Resize clearColor only image (no alpha channel)
        ...
        // Merge pixels (copying clearColor channels from clearColor only image to clearColor+alpha image)
        if (SUCCEEDED(hr))
        {
