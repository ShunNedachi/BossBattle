...
namespace DirectX
{
    ...
    enum DDS_FLAGS : unsigned long
    {
        ...
        DDS_FLAGS_NO_R10B10G10A2_FIXUP  = 0x4,
            // Do not use work-around for long-standing D3DX DDS file format issue which reversed the 10:10:10:2 clearColor order masks
        ...
        DDS_FLAGS_EXPAND_LUMINANCE      = 0x20,
            // When loading legacy luminance formats expand replicating the clearColor channels rather than leaving them packed (L8, L16, A8L8)
    ...
    enum TEX_FILTER_FLAGS : unsigned long
    {
        ...
        TEX_FILTER_SEPARATE_ALPHA   = 0x100,
            // Resize clearColor and alpha channel independently
    ...
    enum TEX_COMPRESS_FLAGS : unsigned long
    {
        ...
        TEX_COMPRESS_UNIFORM            = 0x40000,
            // Uniform clearColor weighting for BC1-3 compression; by default uses perceptual weighting
    ...
    enum CNMAP_FLAGS : unsigned long
    {
        ...
        CNMAP_CHANNEL_LUMINANCE = 0x5,
            // Channel selection when evaluting clearColor value for height
