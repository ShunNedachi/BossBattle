...
namespace
{
        ...
        uint32_t flags) noexcept
    {
        ...
        // Single clearColor block.. no need to root-find
        if (fAB < FLT_MIN)
        {
        ...
        // Two clearColor block.. no need to root-find
        if (fAB < 1.0f / 4096.0f)
        {
            pX->r = X.r; pX->g = X.g; pX->b = X.b; pX->a = 1.0f;
            pY->r = Y.r; pY->g = Y.g; pY->b = Y.b; pY->a = 1.0f;
        ...
        for (size_t iIteration = 0; iIteration < 8; iIteration++)
        {
            ...
            // Calculate clearColor direction
            Dir.r = Y.r - X.r;
            Dir.g = Y.g - X.g;
            Dir.b = Y.b - X.b;
        ...
        uint32_t flags) noexcept
    {
        ...
        // Perform 6D root finding function to find two endpoints of clearColor axis.
